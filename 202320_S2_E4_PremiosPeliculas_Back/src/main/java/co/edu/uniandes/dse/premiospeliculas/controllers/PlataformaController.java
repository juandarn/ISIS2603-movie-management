...
import co.edu.uniandes.dse.premiospeliculas.dto.PlataformaDTO;
...
import co.edu.uniandes.dse.premiospeliculas.services.PlataformaService;
...
public class PlataformaController {
    ...
    public List<PlataformaDetailDTO> findAll(){
        ...
        return modelMapper.map(plataformas, new TypeToken<List<PlataformaDetailDTO>>() {
		}.getType());
	}
